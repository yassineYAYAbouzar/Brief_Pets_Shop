...
<body>
<section>
<form action="./core/update-custumer.php" method="post">
<h1>Update a new costumer</h1>
<div class="form-group">
<label for="text">Id du client:</label>
<input type="number" name="id" placeholder="Enter l'id du client" class="form-control" required>
</div>
<div class="form-group">
